...
public class SimpleCalculatorTest {
    ...
    public void thatAIsBIsCIsDIsAndEIs(int arg0, int arg1, int arg2, int arg3, int arg4) {
    ...
    public void thatAIsEmpty() {
        actual = calculator.Add("");
    }

    @Given("^that a is (\\d+)$")
    public void thatAIs(int arg0) throws Throwable {
    ...
    public void thatAIsBIsCIsDIs(int arg0, int arg1, String arg2, int arg3) throws Throwable {
